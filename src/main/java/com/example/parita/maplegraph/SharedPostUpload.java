...
public class SharedPostUpload extends AppCompatActivity {
    TextView etUsername, timeofreg;
    String ImagePath = "image_path" ;
    String checkemail, userid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shared_post_upload);
        ...
        post = intent.getStringExtra("details");
        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (bitmap==null) {
                    Postupload(userid, posttoupload, picture, dateofupload);
    ...
    public void ImageUploadToServerFunction() {
        ...
        class AsyncTaskUploadClass extends AsyncTask<Void, Void, String> {
            ...
            protected void onPreExecute() {
                ...
                progressDialog = ProgressDialog.show(SharedPostUpload.this, "Your post is been uploading",
            ...
            protected void onPostExecute(String string1) {
                ...
                Toast.makeText(SharedPostUpload.this, string1, Toast.LENGTH_LONG).show();

                Intent toprofile = new Intent(SharedPostUpload.this, HomeScreen.class);
                toprofile.putExtra("email", checkemail);
            ...
            protected String doInBackground(Void... params) {
                ...
                SharedPostUpload.ImageProcessClass imageProcessClass = new SharedPostUpload.ImageProcessClass();
    ...
    public void Postupload(final String email,final  String details,  String image, String timeofreg){
        ...
        class PostuploadClass extends AsyncTask<String,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                progressDialog = ProgressDialog.show(SharedPostUpload.this,"Uploading...",
                        null,true,true);
            }
